...
module.exports = async function handler(req, res) {
  ...
  if (mode === 'quiz') {
    ...
    entry = {
      ...
      decades: Array.isArray(body.decades) ? body.decades.map((d) => (d === 'classic' ? 'classic' : (Number(d) || null))).filter((d) => d != null).slice(0, 10) : [],
    ...
    entry = {
      ...
      filters: {
        ...
        decades: Array.isArray(filters.decades) ? filters.decades.map((d) => (d === 'classic' ? 'classic' : (Number(d) || null))).filter((d) => d != null).slice(0, 10) : [],
