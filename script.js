...
const I18N = {
  ko: {
    ...
    alertNoServer: 'TMDB 서버 연동이 안 돼 있어서 추천을 불러올 수 없어요. README.md를 참고해서 배포해 주세요.',
  ...
  en: {
    ...
    alertNoServer: 'The server isn\'t connected to TMDB, so recommendations aren\'t available. See README.md to deploy.',
